...
<h2 class="sub-header">Tambah Berita Sosial</h2>

<form name="tambah" method="post" action="?tampil=berita_sosial_tambahproses" enctype="multipart/form-data" class="form-horizontal">	
