...
<h2 class="sub-header">Tambah Berita Pendidikan</h2>

<form name="tambah" method="post" action="?tampil=berita_pendidikan_tambahproses" enctype="multipart/form-data" class="form-horizontal">	
