<?php
	...
	if($lokasi_gambar==""){
		mysql_query("UPDATE berita2 SET 
				judul='$_POST[judul]', 
				isi='$isi' 
			WHERE id_berita2='$_POST[id]'") or die(mysql_error());
	}else{
		$data=mysql_fetch_array(mysql_query("select * from berita2 where id_berita2='$_POST[id]'"));
