...
<h2 class="sub-header">Tambah Berita Ekonomi</h2>

<form name="tambah" method="post" action="?tampil=berita_ekonomi_tambahproses" enctype="multipart/form-data" class="form-horizontal">	
