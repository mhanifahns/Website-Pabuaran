<?php
	...
	if($lokasi_gambar==""){
		mysql_query("UPDATE berita1 SET 
				judul='$_POST[judul]', 
				isi='$isi' 
			WHERE id_berita1='$_POST[id]'") or die(mysql_error());
	}else{
		$data=mysql_fetch_array(mysql_query("select * from berita1 where id_berita1='$_POST[id]'"));
