<?php
	...
	$tampil = mysql_query("SELECT * FROM berita1 WHERE id_berita1='$_GET[id]'") or die(mysql_error());
	$data  	= mysql_fetch_array($tampil);
?>
<h2 class="sub-header">Edit Berita Ekonomi</h2>

<form name="edit" method="post" action="?tampil=berita_ekonomi_editproses" enctype="multipart/form-data" class="form-horizontal">
	<input type="hidden" name="id" value="<?php echo $data['id_berita1']; ?>">
